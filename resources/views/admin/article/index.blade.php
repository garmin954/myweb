    ...
    <div class="layui-col-md12">
        <div class="layui-card">
            ...
            <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加广告','{{ route('admin.article.create', array('cate_id'=> request()->get('cate_id'))) }}',600 )"><i class="layui-icon"></i>添加</button>
            </div>
        ...
        layui.use(['table', 'laytpl', 'layer', 'form'], function(){
            ...
            table.on('tool(list)', function(obj){
                ...
                if(obj.event === 'del'){
                    ...
                    xadmin.open('修改配置','{{ route('admin.article.create') }}?id='+data.type_id,600 )
                }
            });
        });
    </script>
